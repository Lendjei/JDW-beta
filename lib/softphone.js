var softphone = function (cntx) {
    ...
    e.on('answerIncomingCall', function (data) {console.log(' ********************************* incomingCall');
    ...
    e.on('ringing', function (data) {console.log(' ********************************* incomingCall');
    ...
    e.on('answered', function (data) {console.log(' ********************************* incomingCall');
    ...
    //Message
    e.on('msgReceived', function (data) {console.log(' ********************************* incomingCall');
